                                ...
                                @foreach ($requests as $request)
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 20%"><a
                                                href="/supervisor/{{ $request->id }}/edit" data-toggle="tooltip"
                                                title="Approve/Dissaprove leave as supervisor">
                                        ...
                                        <td class="text-center" style="width: 3%"> <small><?php
                                                getAllowance($request->allowance); ?></small></td>
                                        ...
                                        <td class="text-center" style="width: 9%">
                                            <a style="text-decoration: none; color: #ffffff" href="# " data-toggle="tooltip"
                                                title="Unit Head Approval" style>
                                                <div class=<?php status($request->approval_status); ?> > {{ $request->approval_status }}
                                            </a>
                                        </td>
                                        <td class="text-center">
                                            <a style="text-decoration: none; color: #ffffff"
                                                href="{{ asset('admin/' . $request->id . '/admin-edit') }}"
                                                data-toggle="tooltip" title="HR Approval">
                                                <div class=<?php status1($request->admin_approval_status);
                                                    ?> >
                                                    <?php echo $request->admin_approval_status === null ?
                                                    'pending' : $request->admin_approval_status; ?>
                                            </a>
                                        </td>
                                        <td class="text-center">
                                            <a href="{{ asset('admin/' . $request->user_id . '/history') }}"
                                                data-toggle="tooltip" title="View Leave History">
                                                <i class="fa fa-calendar fa-3" style="padding-right: 10px"></i>
                                            </a>
                                            <a href="{{ asset('admin/' . $request->id . '/admin-edit') }}"
                                                data-toggle="tooltip" title="Approve/Dissaprove Leave as HR">
