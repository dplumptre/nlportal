                        ...
                        <table id="example" class="table-responsive table table-bordered table-striped" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><a href="{{ asset('admin/add-user') }}" data-toggle="tooltip"
                            ...
                            <tbody>
                                ...
                                @foreach ($employees as $employee)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <small>{{ date('d-M-Y ', strtotime($employee->date_of_hire)) }} </small>
                                        </td>
                                        <td class="text-center">
                                            <a href="{{ asset('profile/' . $employee->id) }}" data-toggle="tooltip"
                                                title="View User">
                                                <i class="fa fa-eye fa-2"
                                                    style="padding-right: 8px; padding-left: 8px;"></i>
                                            </a>
                                            <a href="{{ asset('admin/view-user/' . $employee->id . '/edit') }}"
                                                data-toggle="tooltip" title="Edit User">
                                                <i class="fa fa-edit fa-2"
                                                    style="padding-right: 8px; padding-left: 8px;"></i>
                                            </a>
                                            <a href="{{ asset('admin/delete-user/' . $employee->id) }}"
                                                onclick="javascript:return confirm('Are you sure to delete {{ $employee->name }}')"
                                                data-toggle="tooltip" title="Delete User">
                                                <i class="fa fa-trash fa-2"
                                                    style="padding-right: 8px; padding-left: 8px; color: red"></i>
                                            </a>
                                        </td>
